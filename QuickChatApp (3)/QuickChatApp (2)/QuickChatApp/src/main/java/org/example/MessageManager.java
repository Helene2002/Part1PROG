...
public class MessageManager {
    ...
    //Oracle (2024) Java SE Documentation. Oracle Corporation. Available at: https://docs.oracle.com/javase/(Accessed: 18 November 2025).
    ...
    public void loadStoredMessagesFromJson(String filename) {
        ...
        if (!f.exists() || f.length() == 0) {
            return;  // file doesn't exist or is empty → nothing to load
        }
        ...
        try (FileReader fr = new FileReader(f);
            ...
            while ((line = br.readLine()) != null) {
                ...
                try {
                    ...
                    if (m != null && storedCount < storedMessages.length) {
                        storedMessages[storedCount++] = m;
                    }
                } catch (Exception ex) {
