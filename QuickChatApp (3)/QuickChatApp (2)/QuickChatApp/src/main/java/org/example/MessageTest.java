...
public class MessageTest {
        ...
        void checkMessageExceedsCharacterLimit() {
            ...
            String result = msg.validateMessageLength();
            assertFalse(result.contains("Message exceeds 250 characters"),
        ...
        void testSendMessageOption_Send() {
            ...
            // Use contains() to allow flexibility
            assertTrue(result.toLowerCase().contains("sent"),
                    "User selected 'Send Message' - system should confirm message sent.");
            System.out.println(" testSendMessageOption_Send passed: " + result);
        }
        ...
        void testSendMessageOption_Disregard() {
            ...
            assertFalse(result.toLowerCase().contains("delete") || result.toLowerCase().contains("discard"),
                    "User selected 'Disregard Message' - system should confirm message deletion or discard.");
            System.out.println(" testSendMessageOption_Disregard passed: " + result);
        }
        ...
        void testSendMessageOption_Store() {
            ...
            assertTrue(result.toLowerCase().contains("store") || result.toLowerCase().contains("saved"),
                    "User selected 'Store Message' - system should confirm message stored.");
            System.out.println(" testSendMessageOption_Store passed: " + result) ;
        }
